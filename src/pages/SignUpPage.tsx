        ...
        <div className="w-full max-w-md">
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 md:p-10 shadow-2xl border border-white/50">
            ...
            <p className="mt-8 text-center text-gray-600">
              ...
              <Link to="/signin" className="font-semibold bg-gradient-to-r from-orange-500 to-pink-500 bg-clip-text text-transparent hover:from-orange-600 hover:to-pink-600">
                Sign in
              </Link>
            </p>
          </div>
