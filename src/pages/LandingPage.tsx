...
import { Smartphone, Sparkles, Target, MessageSquare, Zap, ArrowRight, Twitter, Linkedin, Github } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                ...
                className="group relative bg-white rounded-3xl p-8 border-2 border-gray-100 hover:border-transparent transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-2 cursor-pointer"
              >
